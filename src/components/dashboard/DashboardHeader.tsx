...
export function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-gray-300 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
       ...
       <University className="h-6 w-6 text-emerald-600 rounded" />
        ...
        <div className="ml-auto flex flex-1 items-center gap-2 md:ml-6 md:flex-none">
          <div className="relative hidden w-full max-w-xs md:block">
            ...
            <input placeholder="Search..." className="pl-8 border border-gray-300 rounded p-2" />
          </div>
